...
parser.add_argument('--is_savenii',default=True,
...
args = parser.parse_args(args=['--dataset', "Lung",
                            '--cfg', "/root/mnt/works/Study/lung_segmentation_SwinUNet/works/src/Swin-Unet/configs/swin_tiny_patch4_window7_224_lite.yaml",
                            "--num_classes", "2",
                            "--list_dir", "/root/mnt/works/Study/lung_segmentation_SwinUNet/works/datasets/lists",
                            "--output_dir", "/root/mnt/works/Study/lung_segmentation_SwinUNet/works/output",
                            '--max_epochs', "150",
                            '--img_size', "224",
                            '--base_lr', "0.01",
                            '--batch_size', "12"])
if args.dataset == "Synapse":
    ...
    args.volume_path = "/root/mnt/works/Study/lung_segmentation_SwinUNet/works/datasets/npz/val"
